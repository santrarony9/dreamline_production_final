            ...
            <aside className="w-64 bg-[#0a0a0a] border-r border-white/5 flex flex-col fixed h-full z-50">
                ...
                <div className="p-6 border-t border-white/5">
                    <button
                        ...
                        className="w-full text-left flex items-center gap-3 text-[10px] text-red-500/70 hover:text-red-500 font-bold uppercase tracking-widest px-4 py-3 rounded-xl hover:bg-red-500/10 transition-all"
                    >
                        <span>🚪</span> Logout
                    </button>
                </div>
