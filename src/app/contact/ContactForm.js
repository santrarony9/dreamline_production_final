...
export default function ContactForm({ globalData }) {
                    ...
                    <div className="space-y-12">
                        <div className="w-full h-[400px] rounded-[2rem] overflow-hidden border border-white/10 relative">
                            ...
                            {(globalData?.google?.placeId && globalData?.google?.mapsApiKey) ? (
                                ...
                                <iframe
                                    src={`https://maps.google.com/maps?q=${encodeURIComponent("Dreamline Production, " + (contact.address || "85, Tilottama Plaza, Tower 2, First Floor, Karunamoyee Ghat Road, Kolkata 700082"))}&t=&z=15&ie=UTF8&iwloc=&output=embed`}
                                    width="100%"
                                    height="100%"
                                    style={{ border: 0, filter: 'grayscale(100%) invert(100%) contrast(80%)' }}
                                    allowFullScreen=""
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            ...
                            {globalData?.google?.placeId ? (
                                <a href={`https://search.google.com/local/writereview?placeid=${globalData.google.placeId}`} target="_blank" className="flex items-center justify-center gap-2 bg-white/5 border border-[#c5a059]/30 hover:bg-[#c5a059] hover:text-black hover:border-[#c5a059] transition-all duration-300 py-4 rounded-xl group interactive">
                        ...
                        <div className="grid sm:grid-cols-2 gap-8 text-white">
                            ...
                            <div>
                                ...
                                <a href={`mailto:${contact.email || "support@dreamlineproduction.com"}`} className="block text-lg font-bold hover:text-[#c5a059] transition-colors">{contact.email || "support@dreamlineproduction.com"}</a>
                            </div>
                        </div>
                    </div>
                </div>
