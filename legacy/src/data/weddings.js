...
export const weddings = [
    {
        ...
        hoverVideo: 'https://res.cloudinary.com/demo/video/upload/q_auto,vc_auto/dog.mp4', // Placeholder video
        videoUrl: 'https://www.youtube.com/embed/ScMzIvxBSi4',
        albumUrl: 'https://www.canvera.com/e-photobook',
        reviews: [
            { name: "Priya & Rahul", text: "Dreamline made us feel like royalty. The Zamindar theme was captured perfectly!", rating: 5 },
            { name: "Anjali S.", text: "The attention to detail in the rituals was breathtaking.", rating: 5 }
        ],
        storyChapters: [
            {
                title: "Chapter 1: The Expectation",
                images: Array(4).fill('https://images.unsplash.com/photo-1519741497674-611481863552?auto=format&fit=crop&w=600')
            },
            {
                title: "Chapter 2: The Rituals",
                images: Array(4).fill('https://images.unsplash.com/photo-1623192070105-89689871e44f?auto=format&fit=crop&w=600')
            },
            {
                title: "Chapter 3: The Celebration",
                images: Array(4).fill('https://images.unsplash.com/photo-1583939003579-730e3918a45a?auto=format&fit=crop&w=600')
            }
        ],
        vendors: [
            { role: "Venue", name: "Itc Royal Bengal" },
            { role: "Makeup", name: "Aniruddha Chakladar" },
            { role: "Decor", name: "Ferns & Petals" },
            { role: "Outfit", name: "Sabyasachi Mukherjee" }
        ]
    },
    {
        id: 'benarasi-dreams',
        ...
        albumUrl: 'https://www.canvera.com/e-photobook',
        reviews: [
            { name: "Sneha & Amit", text: "Our Benarasi wedding looked like a movie scene. Thank you Rony!", rating: 5 }
        ],
        storyChapters: [
        ...
        vendors: [
            { role: "Venue", name: "Raajkutir Swabhumi" },
            { role: "Makeup", name: "Abhijit Chanda" }
        ]
    },
    {
        ...
        albumUrl: 'https://www.canvera.com/e-photobook',
        reviews: [
            { name: "Meera & Arjun", text: "Elegant, timeless, and classic. Exactly what we wanted.", rating: 5 }
        ],
        storyChapters: [
        ...
        vendors: [
            { role: "Venue", name: "Taj Bengal" },
            { role: "Photography", name: "Dreamline Production" }
        ]
    }
];
